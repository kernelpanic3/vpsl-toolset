...
# x2uno
    } elseif {$input == "x2uno" && $chan == "#VASirens" && $isgeeksirc == 1 && $isVABot == 1} {
...
# search
    } elseif {$input == "wikipedia" && $isgeeksirc == 1 || $isjdnet == 1} {
...
putserv "NOTICE $nick :!wikipedia       - returns an article from the English Wikipedia"
}
...
set toolsetver "1.0b5"
set toolsetdate "5/15/14"
