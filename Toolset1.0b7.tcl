...
# GeeksIRC/JDNet/TestIRC-specific command
    if {$isgeeksirc == 1 || $isjdnet == 1 || $istestirc == 1} {
...
global toolsetver eggdropversion
...
set toolsetver "1.0b7"
set toolsetdate "7/01/14"
...
putlog "PRIVMSG ChanServ kick $chan $nick $chan is not a TF2 channel"
...
putserv "PRIVMSG ChanServ kick $chan $nick $chan is not a TF2 channel"
} else {
...
putlog "$nick made bad attempt to join $input from $chan (no join command), but udef not set - ignoring"
return 1
}
}
...
proc pub_easteregg {nick uhost hand chan args} {
global toolsetver eggdropversion
putlog "$nick FOUND THE EASTER EGG IN $chan! :D"
puthelp "PRIVMSG $nick :$botnick toolset $toolsetver on Eggdrop $eggdropversion by VASirens/WikiPuppies."
puthelp "PRIVMSG $nick :Special thanks to..."
puthelp "PRIVMSG $nick :Oldiesmann - programming assistance"
puthelp "PRIVMSG $nick :Jasper_Deng - founding JDNet, ideas, testing"
puthelp "PRIVMSG $nick :blindsight - founding GeeksIRC, ideas, testing"
