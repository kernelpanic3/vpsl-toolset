...
bind pub - !join pub_not-tf2-join
bind pub - ?join pub_not-tf2-join
bind pub - .join pub_not-tf2-join
bind pub - #tf2.mix.nahl pub_not-tf2-join
bind pub - #tf2.mix.euhl pub_not-tf2-join
bind pub - #tf2.pug.nahl pub_not-tf2-join
bind pub - #tf2.pug.na pub_not-tf2-join
bind pub - #tf2scrim pub_not-tf2-join
bind pub - #tf2.mix.eu pub_not-tf2-join
bind pub - #tf2scrim.hl pub_not-tf2-join
...
set toolsetver "1.0b3"
set toolsetdate "4/11/14"
...
proc pub_not-tf2-join {nick uhost hand chan input args} {
