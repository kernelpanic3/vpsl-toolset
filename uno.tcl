...
#
# Changelog:
# 0.99.2: Fixed error in WDE lettering. Message tweaks.
# 0.99.1: Eliminated bind/proc overlap with Double Uno with lots of kludging.
...
set UnoDrawTwoCard	"\002Draw Four\002 \003 "
set UnoWildCard		"\0031,8 \002W\0030,3I \0030,4L\0030,12D\002 \003 "
set UnoWildDrawFourCard "\0031,8\002W\0030,3I\0030,4L\0030,12D \0031,8D\0030,3r\0030,4a\0030,12w \0031,8E\0030,3i\0030,4g\0030,12h\0030,8t\003\002 "
set UnoLogo		"\002DOUBLE \0033U\00312N\00313O\00308!\002\003"
...
proc uno_playwilddrawfourcard {nick pickednum crd isrobot} {
 ...
 uno_adddrawtohand $PlayerThatDrew $PlayerThatDrewIDX 8
 ...
 switch $cardfound {
  0 {
   if {$isrobot} {
    ...
    unomsg "Oops: UnoRobot oops $crd (somebody call my owner)"
   } {
...
proc UnoCmds {nick uhost hand chan txt} {
 ...
 unomsg "$UnoLogo Commands: !uno !stop !remove \[nick\] !unowon \[nick\] !unocmds"
...
proc uno_checkuno {cplayer} {
 ...
 unomsg "\001ACTION smashes $cplayer with an anvil.\001"
 return
}
...
proc uno_showplaydraw {who crd dplayer nplayer} {
 unomsg "[unonik $who]\003 plays $crd [unonik $dplayer]\003 draws \002four cards\002 and skips to [unonik $nplayer]..."
}
...
proc uno_showplaywildfour {who skipper chooser} {
 ...
 unomsg "[unonik $who]\003 plays $UnoWildDrawFourCard [unonik $skipper]\003 draws \002eight cards\002 and is skipped...choose a color [unonik $chooser]!"
}
