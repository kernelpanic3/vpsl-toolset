...
set toolsetver "1.0b10"
set toolsetdate "8/19/14"
...
if {$argcheck == "scores" && $argall != "all"} {
    ...
    roulette_showall $nick $host $handle $chan $arg
        ...
        utimer 20 [list roulette_timeout $chan ]
...
proc roulette_timeout { chan } {
    global botnick roulette_player1 roulette_player2 roulette_turns roulette_curplayer roulette_started roulette_bullet roulette_lucky_msg roulette_pull roulette_timeout_timer
    if {$roulette_timeout_timer == 1} {
